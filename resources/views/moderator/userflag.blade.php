                        ...
                        <table class="col-md-12">
                            <tbody>
                                @foreach($patrol as $flag)
                                    ...
                                    >
                                        <td>
                                            <a href="https://funnyjunk.com/find/{{strtolower($flag->type)}}/{{$flag->cid}}?redirect=1" rel="noreferrer">{{$flag->type}} {{$flag->cid}}</a>
                            ...
                            <tbody>
                                @foreach($content as $flag)
                                    ...
                                    >
                                        ...
                                        <td><a href="https://funnyjunk.com/find/{{strtolower($flag->type)}}/{{$flag->cid}}?redirect=1" rel="noreferrer">{{$flag->type}} {{$flag->cid}}</a></td>
                                        <td>{{$flag->reason}}</td>
                                        <td>{{$flag->amount}}</td>
                                    </tr>
                                @endforeach
