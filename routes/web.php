...
Route::group(['middleware' => ['auth','web']], function () {
    ...
    Route::group(['domain' => env('APP_URI')], function () {
        ...
        Route::post('/mods/complaints/{modCase}', 'ModCaseController@addCaseMessage')->middleware('role:mod.isExec,mod.complaintsResponder')->name('moderator.case.postmessage');
        ...
        Route::get('/mods/complaints/{modCase}/toggleCaseLock', 'ModCaseController@toggleCaseLock')->middleware('role:mod.isExec,mod.complaintsResponde')->name('moderator.case.togglecaselock');
        Route::get('/mods/complaints/{modCase}/resolveCase', 'ModCaseController@resolveCase')->middleware('role:mod.isExec,mod.complaintsResponde')->name('moderator.case.resolvecase');
